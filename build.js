...
const envVars = {
  ...
  VITE_RESEND_API_KEY: process.env.VITE_RESEND_API_KEY || 're_4mqwvFap_LqaRLWYajRPUiFEE5zu1BUF8',
...
try {
  ...
  const staticFiles = ['styles.css', 'admin-styles.css', 'script.js', 'admin-script.js', 'appwrite-config.js', 'video-manager.js', 'seo-enhancer.js', 'sitemap.xml', 'robots.txt'];
